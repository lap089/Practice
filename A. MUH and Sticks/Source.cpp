...
//	cout << size;
	if (size == 1)
		...
		if (mMap.begin()->second == 4 || mMap.begin()->second == 2)
			cout << "Elephant";
		else if (mMap.begin()->second == 5 || mMap.begin()->second == 1)
			cout << "Bear";
		else cout << "Alien";
	else if (size == 3 && (mMap.begin()->second == 4 || (mMap.begin()->second == 1 && (++mMap.begin())->second == 1 || (++mMap.begin())->second == 4)))
		cout << "Bear";
	else
		cout << "Alien";
